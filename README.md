...
1. Creación de un repositorio de GitHub para alojar el código de la aplicación web. En nuestro caso [AWS-WebAppAutoDeploy](https://github.com/ccalvop/AWS-WebAppAutoDeploy)
